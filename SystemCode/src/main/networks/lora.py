...
# Consider the possibility that this method will be called from outside
# network_dim, network_alpha have default values.
# block_dims, block_alphas are both None or both have values
# conv_dim, conv_alpha are both None or both have values
def get_block_dims_and_alphas(
    ...
    # Parse block_dims and block_alphas
    ...
    # Parse conv_block_dims and conv_block_alphas only if specified. If not specified, use conv_dim and conv_alpha
...
# Define the multiplier for the learning rate for each layer
...
# Exclude blocks with lr_weight 0 from block_dims, taking into consideration the possibility of calling them from outside.
